...
public class Snake {
	...
	public void update(int delta, Food food, Input input) {
	...
	public void setMove(Move move) {
		if (this.move == Move.UP && move != Move.DOWN ||
				this.move == Move.DOWN && move != Move.UP ||
				this.move == Move.LEFT && move != Move.RIGHT ||
